  ...
  return (
    <div className="mb-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-background)] p-3 text-xs">
      ...
      <div className="flex gap-1.5 mb-2">
        ...
        />
        <button onClick={() => setDraft(generateTopic())} className="px-2 py-1.5 rounded border border-[var(--color-border)] text-neutral-400 hover:text-violet-300 transition text-[10px]">
          Générer
        </button>
      </div>

...
/**
 * GET /api/instagram/export?metier=&hasWebsite=&withEmail=
 * Exporte les profils Instagram en CSV (Excel FR). Filtres optionnels.
 */
export async function GET(req: NextRequest) {
  ...
  let query = supabase
    ...
    .select(
      "username, full_name, email, phone, followers, follows_count, posts_count, category, metier, ville, is_business, verified, has_website, external_url, profile_pic_url, bio, hashtag_source, status",
    )
